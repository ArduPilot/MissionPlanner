...
namespace MissionPlanner.Joystick
{
    public partial class Joy_Mount_Mode : Form
    {
        public Joy_Mount_Mode(string name)
        {
            ...
            var item1 = Utilities.ParameterMetaDataRepository.GetParameterOptionsInt("MNT_MODE",
                MainV2.comPort.MAV.cs.firmware.ToString());
            var item2 = Utilities.ParameterMetaDataRepository.GetParameterOptionsInt("MNT_DEFLT_MODE",
                MainV2.comPort.MAV.cs.firmware.ToString());
            if (item1.Count > 0)
