...
namespace MissionPlanner.Joystick
{
    public partial class ConfigureCameraJoystick : Form
    {
        ...
        private void ConfigureCameraJoystick_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                var joysticklist = CameraJoystick.getDevices();
            ...
            PAN_AXIS.DataSource = (Enum.GetValues(typeof(joystickaxis)));
            TILT_AXIS.DataSource = (Enum.GetValues(typeof(joystickaxis)));
            ZOOM_AXIS.DataSource = (Enum.GetValues(typeof(joystickaxis)));
            ...
            {
                var config = tempjoystick.getChannel((int)ca);
                    ...
                    if (joy == null)
                    {
                        ...
                        if (PAN_AXIS.Text != "")
                        {
                            joy.setChannel(
                              ...
                              (joystickaxis)Enum.Parse(typeof(joystickaxis), PAN_AXIS.Text),
                              PAN_REV.Checked,
                        ...
                        if (TILT_AXIS.Text != "")
                        {
                            joy.setChannel(
                              ...
                              (joystickaxis)Enum.Parse(typeof(joystickaxis), TILT_AXIS.Text),
                              TILT_REV.Checked,
                        ...
                        if (ZOOM_AXIS.Text != "")
                        {
                            joy.setChannel(
                              ...
                              (joystickaxis)Enum.Parse(typeof(joystickaxis), ZOOM_AXIS.Text),
                              ZOOM_REV.Checked,
        ...
        {
            if (MainV2.camerajoystick != null)
                MainV2.camerajoystick.setReverse((int)CameraJoystick.CameraAxis.Pan, ((CheckBox)sender).Checked);
        }

        private void TILT_REV_CheckedChanged(object sender, EventArgs e)
        {
            if (MainV2.camerajoystick != null)
                MainV2.camerajoystick.setReverse((int)CameraJoystick.CameraAxis.Tilt, ((CheckBox)sender).Checked);
        }

        private void ZOOM_REV_CheckedChanged(object sender, EventArgs e)
        {
            if (MainV2.camerajoystick != null)
                MainV2.camerajoystick.setReverse((int)CameraJoystick.CameraAxis.Zoom, ((CheckBox)sender).Checked);
        }
