...
namespace MissionPlanner.Controls
{
    public partial class DroneCANFileUI : UserControl
    {
        ...
        public DroneCANFileUI(DroneCAN.DroneCAN can, byte nodeid)
        {
            _can = can;
            _nodeid = nodeid;
        ...
        public class DirectoryInfo : FileSystemInfo
        {
            private readonly DroneCAN.DroneCAN _can;
            private readonly byte _nodeid;
            private List<DroneCAN.DroneCAN.DroneCANFileInfo> cache;
            ...
            public async Task<IEnumerable<DroneCAN.DroneCAN.DroneCANFileInfo>> GetFiles()
            {
                if (cache == null)
