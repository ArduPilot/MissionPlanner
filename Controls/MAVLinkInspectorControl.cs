...
{
    public class MAVLinkInspectorControl : UserControl
    {
        ...
        public MAVLinkInspectorControl()
        {
            InitializeComponent();
        }
        ...
        public void Activate()
        {
            ...
            timer1.Tick += (sender, args) => UpdateTree();
        ...
        {
            if (treeView1 == null || treeView1.IsDisposed)
                return;
        ...
        private void InitializeComponent()
        {
            ...
            this.treeView1 = new MissionPlanner.Controls.MAVLinkInspectorControl.MyTreeView();
            ...
            this.Name = "MAVLinkInspectorControl";
