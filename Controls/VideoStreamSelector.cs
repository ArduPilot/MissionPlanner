...
namespace MissionPlanner.Controls
{
    public partial class VideoStreamSelector : Form
    {
        ...
        public VideoStreamSelector()
        {
            ...
            cmb_detectedstreams.DataSource = CameraProtocol.VideoStreams.Values.Select(x => new KeyValuePair<string, string>(System.Text.Encoding.UTF8.GetString(x.name), System.Text.Encoding.UTF8.GetString(x.uri))).ToList();
