    ...
    public partial class ConfigHWRangeFinder : MyUserControl, IActivate, IDeactivate
    {
        ...
        private void CMB_sonartype_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (CMB_sonartype.Text == "TeraRangerOne-I2C")
            {
                ...
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "RNGFND_MAX_CM", 100);
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "RNGFND_MIN_CM ", 20);
            }
        }
    }
}