...
namespace MissionPlanner.GCSViews.ConfigurationView
{
    public partial class ConfigAntennaTracker : MyUserControl, IActivate, IDeactivate
    {
        ...
        private void BUT_test_yaw_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                MainV2.comPort.doCommand(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, MAVLink.MAV_CMD.DO_SET_SERVO, 1, (float)output, 0, 0, 0, 0, 0);
            }
            catch
            {
        ...
        private void BUT_test_pitch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                MainV2.comPort.doCommand(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, MAVLink.MAV_CMD.DO_SET_SERVO, 2, (float)output, 0, 0, 0, 0, 0);
            }
            catch
            {
                CustomMessageBox.Show(Strings.ErrorNoResponse, Strings.ERROR);
