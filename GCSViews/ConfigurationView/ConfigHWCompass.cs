    ...
    public partial class ConfigHWCompass : MyUserControl, IActivate
    {
        ...
        private void TXT_declination_Validated(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_DEC", dec * MathHelper.deg2rad);
                }
            }
            catch
            {
        ...
        private void CHK_enablecompass_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "MAG_ENABLE", ((CheckBox)sender).Checked ? 1 : 0);
                }
            }
            catch
            {
        ...
        private void CHK_autodec_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_AUTODEC", ((CheckBox)sender).Checked ? 1 : 0);
                }
            }
            catch
            {
        ...
        private void buttonQuickPixhawk_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_USE", 1);
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_USE2", 1);
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_USE3", 0);
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_EXTERNAL", 1);
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_EXTERN2", 0);
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_EXTERN3", 0);

                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_PRIMARY", 0);
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_LEARN", 1);
                ...
                else
                {
                    ...
                    MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_EXTERNAL", 0);
                }
            }
            catch (Exception)
            {
        ...
        private void QuickAPM25_Click(object sender, EventArgs e)
        {
            ...
            {
                CMB_compass1_orient.SelectedIndex = (int)Rotation.ROTATION_NONE;
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_USE1", 1);
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_USE2", 0);
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_USE3", 0);
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_EXTERNAL", 0);
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_EXTERN2", 0);
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_EXTERN3", 0);
        ...
        private void CHK_compasslearn_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "COMPASS_LEARN", ((CheckBox)sender).Checked ? 1 : 0);
                }
            }
            catch
            {
