...
namespace MissionPlanner.GCSViews.ConfigurationView
{
    public partial class ConfigArducopter : MyUserControl, IActivate
    {
        ...
        public void Activate()
        {
            ...
            TUNE_LOW.setup(0, 10000, 1, 0.01f, new[] { "TUNE_LOW", "TUNE_MIN" }, MainV2.comPort.MAV.param);
            TUNE_HIGH.setup(0, 10000, 1, 0.01f, new[] { "TUNE_HIGH", "TUNE_MAX" }, MainV2.comPort.MAV.param);
