...
namespace MissionPlanner.GCSViews.ConfigurationView
{
    public partial class ConfigFrameClassType : MyUserControl, IActivate, IDeactivate
    {
        ...
        private void SetFrameParam(motor_frame_class frame_class, motor_frame_type frame_type)
        {
            try
            {
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "FRAME_CLASS", (int)frame_class);
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "FRAME_TYPE", (int)frame_type);
            }
            catch
            {
