    ...
    public partial class ConfigTradHeli : MyUserControl, IActivate, IDeactivate
    {
        ...
        private void H_SWASH_TYPE_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "H_SWASH_TYPE", ((RadioButton)sender).Checked ? 1 : 0);
                }
            }
            catch
            {
        ...
        private void TXT_srvpos1_Validating(object sender, CancelEventArgs e)
        {
            ...
            try
            {
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "H_SV_MAN", 1); // randy request
                MainV2.comPort.setParam(((Control)sender).Name, test);
                Thread.Sleep(100);
                MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "H_SV_MAN", 0); // randy request - last
            }
            catch
            {
        ...
        private void myButtonH_SV_MAN_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "H_SV_MAN", 0);
                }
            }
            catch
            {
        ...
        private void myButtonH_SV_MANmanual_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "H_SV_MAN", 1);
                }
            }
            catch
            {
        ...
        private void myButtonH_SV_MANmax_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "H_SV_MAN", 2);
                }
            }
            catch
            {
        ...
        private void myButtonH_SV_MANzero_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "H_SV_MAN", 3);
                }
            }
            catch
            {
        ...
        private void myButtonH_SV_MANmin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "H_SV_MAN", 4);
                }
            }
            catch
            {
        ...
        private void myButtonH_SV_MANtest_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MainV2.comPort.setParam(MainV2.comPort.sysidcurrent, (byte)MainV2.comPort.compidcurrent, "H_SV_MAN", 5);
                }
            }
            catch
            {
