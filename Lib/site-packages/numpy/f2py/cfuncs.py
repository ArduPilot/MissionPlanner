...
#define old_shape(var,dim) (PyArray_DIMS((PyArrayObject *)(capi_ ## var ## _tmp))[dim])
...
#define TRYPYARRAYTEMPLATE(ctype,typecode) \\
        ...
        switch (PyArray_DESCR(arr)->type_num) {\\
                ...
                case PyArray_FLOAT: *(float *)(PyArray_DATA(arr))=*v; break;\\
                case PyArray_CDOUBLE: *(double *)(PyArray_DATA(arr))=*v; break;\\
                case PyArray_CFLOAT: *(float *)(PyArray_DATA(arr))=*v; break;\\
                case PyArray_BOOL: *(npy_bool *)(PyArray_DATA(arr))=(*v!=0); break;\\
                case PyArray_UBYTE: *(unsigned char *)(PyArray_DATA(arr))=*v; break;\\
                case PyArray_BYTE: *(signed char *)(PyArray_DATA(arr))=*v; break;\\
                case PyArray_SHORT: *(short *)(PyArray_DATA(arr))=*v; break;\\
                case PyArray_USHORT: *(npy_ushort *)(PyArray_DATA(arr))=*v; break;\\
                case PyArray_UINT: *(npy_uint *)(PyArray_DATA(arr))=*v; break;\\
                case PyArray_ULONG: *(npy_ulong *)(PyArray_DATA(arr))=*v; break;\\
                case PyArray_LONGLONG: *(npy_longlong *)PyArray_DATA(arr)=*v; break;\\
...
#define TRYCOMPLEXPYARRAYTEMPLATEOBJECT case PyArray_OBJECT: (arr->descr->f->setitem)(pyobj_from_complex_ ## ctype ## 1((*v)), PyArray_DATA(arr), arr); break;
#define TRYCOMPLEXPYARRAYTEMPLATE(ctype,typecode)\\
        ...
        switch (arr->descr->type_num) {\\
                case PyArray_CDOUBLE: *(double *)PyArray_DATA(arr)=(*v).r;*(double *)(PyArray_DATA(arr)+sizeof(double))=(*v).i;break;\\
                case PyArray_CFLOAT: *(float *)PyArray_DATA(arr)=(*v).r;*(float *)(PyArray_DATA(arr)+sizeof(float))=(*v).i;break;\\
                case PyArray_DOUBLE: *(double *)(PyArray_DATA(arr))=(*v).r; break;\\
                case PyArray_LONG: *(long *)(PyArray_DATA(arr))=(*v).r; break;\\
                case PyArray_FLOAT: *(float *)(PyArray_DATA(arr))=(*v).r; break;\\
                case PyArray_INT: *(int *)(PyArray_DATA(arr))=(*v).r; break;\\
                case PyArray_BOOL: *(npy_bool *)(PyArray_DATA(arr))=((*v).r!=0 && (*v).i!=0)); break;\\
                case PyArray_UBYTE: *(unsigned char *)(PyArray_DATA(arr))=(*v).r; break;\\
                case PyArray_BYTE: *(signed char *)(PyArray_DATA(arr))=(*v).r; break;\\
                case PyArray_SHORT: *(short *)(PyArray_DATA(arr))=(*v).r; break;\\
                case PyArray_USHORT: *(npy_ushort *)(PyArray_DATA(arr))=(*v).r; break;\\
                case PyArray_UINT: *(npy_uint *)(PyArray_DATA(arr))=(*v).r; break;\\
                case PyArray_ULONG: *(npy_ulong *)(PyArray_DATA(arr))=(*v).r; break;\\
                case PyArray_LONGLONG: *(npy_longlong *)(PyArray_DATA(arr))=(*v).r; break;\\
                case PyArray_ULONGLONG: *(npy_ulonglong *)(PyArray_DATA(arr))=(*v).r; break;\\
                case PyArray_LONGDOUBLE: *(npy_longdouble *)(PyArray_DATA(arr))=(*v).r; break;\\
                case PyArray_CLONGDOUBLE: *(npy_longdouble *)(PyArray_DATA(arr))=(*v).r;*(npy_longdouble *)(PyArray_DATA(arr)+sizeof(npy_longdouble))=(*v).i;break;\\
                case PyArray_OBJECT: (arr->descr->f->setitem)(pyobj_from_complex_ ## ctype ## 1((*v)),PyArray_DATA(arr), arr); break;\\
                default: return -2;\\
        };\\
        return -1;
"""
...
\t\tii += (ii*(PyArray_DIMS(arr)[k] - 1)+i[k]); /* assuming contiguous arr */
\treturn ii;
}"""
...
\tfor (k=1; k < PyArray_NDIM(arr); k++)
\t\tii += (ii*(PyArray_DIMS(arr)[PyArray_NDIM(arr)-k-1] - 1)+i[PyArray_NDIM(arr)-k-1]); /* assuming contiguous arr */
\treturn ii;
}"""
cfuncs['forcomb']="""\
