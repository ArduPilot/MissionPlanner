...
4. Try a diffrent usb port\n\n" +
        ...
        */
        ...
        private Hashtable getParamListBG()
        {
            ...
            // this speeds up fetching of parameter list.
            pauseStreams = true;
            stopall(false);
...
// flush on heartbeat - 1 seconds
        ...
        public FileStream GetLog(ushort no)
        {
            ...
            // make download faster over slow telemetry link
            pauseStreams = true;
            stopall(false);
            ...
            while (true)
            {
                ...
                if (buffer.Length > 5)
                {
                    MAVLINK_MSG_ID id = (MAVLINK_MSG_ID)buffer[5];
                    if (id == MAVLINK_MSG_ID.LOG_DATA)
                    {
                    ...
                    {
                        Debug.WriteLine("Ignoring {0} while downloading log");
                    }
                }
            }
