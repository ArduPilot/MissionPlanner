                                ...
                                function(e) {
                                    ...
                                    case 0:
                                        return u
                                            ? [
                                                4,
                                                DotNet.invokeMethodAsync(u.assemblyName, u.functionName, location.href)
                                            ]
                                            : [3, 2];
                                    case 1:
                                        e.sent(),
                ...
                var r,
                    ...
                    a = (r = {},
                        [
                            ...
                            "mouseleave", "progress", "reset", "scroll", "submit", "unload",
                        ...
                        for (var l = 0, s = o, c = e.arraySegmentReader, f = e.editReader, d = e.frameReader, p = c.values(i), m = c.offset(i), h = m + c.count(i), y = m; y < h; y++) {
                            ...
                            switch (g) {
                                ...
                                case r.EditType.removeAttribute:
                                    var I;
                                    E = f.siblingIndex(v);
                                    if (!((I = a.getLogicalChild(n, s + E)) instanceof HTMLElement))
                                        throw new Error("Cannot remove attribute from non-element child");
                                    var _ = f.removedAttributeName(v);
                                    this.tryApplySpecialProperty(e, I, _, null) || I.removeAttribute(_);
                                    break;
        ...
        t.BrowserRenderer = c*/
                ...
                t.monoPlatform = {
                                    ...
                                    Module = function(e, n, f) {
                                        ...
                                        return d.print = function(e) {
                                            ...
                                            d.locateFile = function(e) {
                                                ...
                                                case "mono.asm.js":
                                                    return "_framework/asmjs/mono.asm.js";
                                                default:
                                                    return e
                                                }
                                            },
                                            d.preRun.push(function() {
                                                r = Module.cwrap("mono_wasm_assembly_load", "number", ["string"]),
                                                    ...
                                                    e.forEach(function(e) {
                                                        var t = s.getFileNameFromUrl(e), n = "blazor:" + t;
                                                        addRunDependency(n),
                                                            function(e) {
                                                                return new Promise(function(t, n) {
                                                        ...
                                                        beginInvokeDotNetFromJS: function(e, n, o, a, i) {
                                                            ...
                                                            t.monoPlatform.callMethod(r,
                                                                ...
                                                                [
                                                                    ...
                                                                    : null, t.monoPlatform.toDotNetString(u),
                                                        ...
                                                        invokeDotNetFromJS: function(n, r, o, a) {
                                                            var i = t.monoPlatform.callMethod(e,
                                                                ...
                                                                [
                                                                    ...
                                                                    : null, t.monoPlatform.toDotNetString(a)
                                                                ]);
                    ...
                    callMethod: function (e, n, r) {
                        ...
                        try {
                            for (var a = Module.stackAlloc(r.length), u = Module.stackAlloc(4), l = 0;
                                l < r.length;
                                ++l)
