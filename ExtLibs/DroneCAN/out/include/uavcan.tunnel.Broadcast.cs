...
//using uavcan.tunnel.Protocol.cs
        public partial class uavcan_tunnel_Broadcast: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_tunnel_Broadcast(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_tunnel_Broadcast(transfer, this, fdcan);
            }

            public static uavcan_tunnel_Broadcast ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
