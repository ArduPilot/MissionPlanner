...
namespace DroneCAN
{
    public partial class DroneCAN 
    {
        public partial class uavcan_protocol_GlobalTimeSync: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_protocol_GlobalTimeSync(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_protocol_GlobalTimeSync(transfer, this, fdcan);
            }

            public static uavcan_protocol_GlobalTimeSync ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
