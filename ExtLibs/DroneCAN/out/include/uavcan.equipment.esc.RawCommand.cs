...
namespace DroneCAN
{
    public partial class DroneCAN 
    {
        public partial class uavcan_equipment_esc_RawCommand: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_equipment_esc_RawCommand(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_equipment_esc_RawCommand(transfer, this, fdcan);
            }

            public static uavcan_equipment_esc_RawCommand ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
