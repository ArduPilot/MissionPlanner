...
namespace DroneCAN
{
    public partial class DroneCAN 
    {
        public partial class uavcan_equipment_air_data_IndicatedAirspeed: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_equipment_air_data_IndicatedAirspeed(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_equipment_air_data_IndicatedAirspeed(transfer, this, fdcan);
            }

            public static uavcan_equipment_air_data_IndicatedAirspeed ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
