...
namespace DroneCAN
{
    public partial class DroneCAN 
    {
        public partial class uavcan_protocol_file_Path: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_protocol_file_Path(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_protocol_file_Path(transfer, this, fdcan);
            }

            public static uavcan_protocol_file_Path ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
                var ans = new uavcan_protocol_file_Path();
