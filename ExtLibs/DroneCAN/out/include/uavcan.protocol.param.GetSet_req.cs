...
//using uavcan.protocol.param.Value.cs
        public partial class uavcan_protocol_param_GetSet_req: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_protocol_param_GetSet_req(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_protocol_param_GetSet_req(transfer, this, fdcan);
            }

            public static uavcan_protocol_param_GetSet_req ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
                var ans = new uavcan_protocol_param_GetSet_req();
