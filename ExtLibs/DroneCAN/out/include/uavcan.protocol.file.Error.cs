...
namespace DroneCAN
{
    public partial class DroneCAN 
    {
        public partial class uavcan_protocol_file_Error: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_protocol_file_Error(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_protocol_file_Error(transfer, this, fdcan);
            }

            public static uavcan_protocol_file_Error ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
