...
namespace DroneCAN
{
    public partial class DroneCAN 
    {
        public partial class dronecan_remoteid_SecureCommand_req: IDroneCANSerialize 
        {
            ...
            {
                encode_dronecan_remoteid_SecureCommand_req(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_dronecan_remoteid_SecureCommand_req(transfer, this, fdcan);
            }

            public static dronecan_remoteid_SecureCommand_req ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
