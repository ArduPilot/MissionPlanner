...
//using uavcan.protocol.debug.LogLevel.cs
        public partial class uavcan_protocol_debug_LogMessage: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_protocol_debug_LogMessage(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_protocol_debug_LogMessage(transfer, this, fdcan);
            }

            public static uavcan_protocol_debug_LogMessage ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
