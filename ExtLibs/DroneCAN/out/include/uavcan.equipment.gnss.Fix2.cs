...
//using uavcan.Timestamp.cs
        public partial class uavcan_equipment_gnss_Fix2: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_equipment_gnss_Fix2(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_equipment_gnss_Fix2(transfer, this, fdcan);
            }

            public static uavcan_equipment_gnss_Fix2 ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
