...
namespace DroneCAN
{
    public partial class DroneCAN 
    {
        public partial class uavcan_equipment_hardpoint_Command: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_equipment_hardpoint_Command(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_equipment_hardpoint_Command(transfer, this, fdcan);
            }

            public static uavcan_equipment_hardpoint_Command ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
