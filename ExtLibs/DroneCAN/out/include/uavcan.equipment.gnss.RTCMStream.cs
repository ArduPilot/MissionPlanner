...
namespace DroneCAN
{
    public partial class DroneCAN 
    {
        public partial class uavcan_equipment_gnss_RTCMStream: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_equipment_gnss_RTCMStream(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_equipment_gnss_RTCMStream(transfer, this, fdcan);
            }

            public static uavcan_equipment_gnss_RTCMStream ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
