...
//using uavcan.protocol.file.Path.cs
        public partial class uavcan_protocol_file_Delete_req: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_protocol_file_Delete_req(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_protocol_file_Delete_req(transfer, this, fdcan);
            }

            public static uavcan_protocol_file_Delete_req ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
