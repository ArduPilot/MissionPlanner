...
namespace DroneCAN
{
    public partial class DroneCAN 
    {
        public partial class uavcan_protocol_SoftwareVersion: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_protocol_SoftwareVersion(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_protocol_SoftwareVersion(transfer, this, fdcan);
            }

            public static uavcan_protocol_SoftwareVersion ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
