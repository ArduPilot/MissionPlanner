...
namespace DroneCAN
{
    public partial class DroneCAN 
    {
        public partial class uavcan_equipment_ahrs_MagneticFieldStrength: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_equipment_ahrs_MagneticFieldStrength(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_equipment_ahrs_MagneticFieldStrength(transfer, this, fdcan);
            }

            public static uavcan_equipment_ahrs_MagneticFieldStrength ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
                var ans = new uavcan_equipment_ahrs_MagneticFieldStrength();
