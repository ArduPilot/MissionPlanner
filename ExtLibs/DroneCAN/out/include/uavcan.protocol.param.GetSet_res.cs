...
//using uavcan.protocol.param.NumericValue.cs
        public partial class uavcan_protocol_param_GetSet_res: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_protocol_param_GetSet_res(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_protocol_param_GetSet_res(transfer, this, fdcan);
            }

            public static uavcan_protocol_param_GetSet_res ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
