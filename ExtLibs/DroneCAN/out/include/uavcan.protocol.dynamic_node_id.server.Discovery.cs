...
namespace DroneCAN
{
    public partial class DroneCAN 
    {
        public partial class uavcan_protocol_dynamic_node_id_server_Discovery: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_protocol_dynamic_node_id_server_Discovery(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_protocol_dynamic_node_id_server_Discovery(transfer, this, fdcan);
            }

            public static uavcan_protocol_dynamic_node_id_server_Discovery ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
