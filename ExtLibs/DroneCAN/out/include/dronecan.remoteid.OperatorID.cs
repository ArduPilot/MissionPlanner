...
namespace DroneCAN
{
    public partial class DroneCAN 
    {
        public partial class dronecan_remoteid_OperatorID: IDroneCANSerialize 
        {
            ...
            {
                encode_dronecan_remoteid_OperatorID(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_dronecan_remoteid_OperatorID(transfer, this, fdcan);
            }

            public static dronecan_remoteid_OperatorID ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
