...
//using uavcan.CoarseOrientation.cs
        public partial class uavcan_equipment_range_sensor_Measurement: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_equipment_range_sensor_Measurement(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_equipment_range_sensor_Measurement(transfer, this, fdcan);
            }

            public static uavcan_equipment_range_sensor_Measurement ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
