...
namespace DroneCAN
{
    ...
    {
        public partial class com_hex_equipment_gnss_Signal: IDroneCANSerialize 
        {
            ...
            public static com_hex_equipment_gnss_Signal ByteArrayToDroneCANMsg(byte[] transfer, int startoffset)
            {
                var ans = new com_hex_equipment_gnss_Signal();
