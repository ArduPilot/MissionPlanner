...
//using uavcan.Timestamp.cs
        public partial class uavcan_equipment_ahrs_Solution: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_equipment_ahrs_Solution(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_equipment_ahrs_Solution(transfer, this, fdcan);
            }

            public static uavcan_equipment_ahrs_Solution ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
