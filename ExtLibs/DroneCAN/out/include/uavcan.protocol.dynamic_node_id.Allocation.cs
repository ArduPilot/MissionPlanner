...
namespace DroneCAN
{
    public partial class DroneCAN 
    {
        public partial class uavcan_protocol_dynamic_node_id_Allocation: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_protocol_dynamic_node_id_Allocation(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_protocol_dynamic_node_id_Allocation(transfer, this, fdcan);
            }

            public static uavcan_protocol_dynamic_node_id_Allocation ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
                var ans = new uavcan_protocol_dynamic_node_id_Allocation();
