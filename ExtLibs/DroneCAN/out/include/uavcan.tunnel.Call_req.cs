...
//using uavcan.tunnel.Protocol.cs
        public partial class uavcan_tunnel_Call_req: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_tunnel_Call_req(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_tunnel_Call_req(transfer, this, fdcan);
            }

            public static uavcan_tunnel_Call_req ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
