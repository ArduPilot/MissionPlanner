...
namespace DroneCAN
{
    public partial class DroneCAN 
    {
        public partial class uavcan_protocol_AccessCommandShell_req: IDroneCANSerialize 
        {
            ...
            {
                encode_uavcan_protocol_AccessCommandShell_req(this, chunk_cb, ctx, fdcan);
            }

            public void decode(CanardRxTransfer transfer, bool fdcan = false)
            {
                decode_uavcan_protocol_AccessCommandShell_req(transfer, this, fdcan);
            }

            public static uavcan_protocol_AccessCommandShell_req ByteArrayToDroneCANMsg(byte[] transfer, int startoffset, bool fdcan = false)
            {
