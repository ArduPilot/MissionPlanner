...
namespace DroneCAN
{
    public partial class DroneCAN {
        ...
        {
            public static void encode_uavcan_protocol_param_Value(uavcan_protocol_param_Value msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool fdcan) {
                uint8_t[] buffer = new uint8_t[8];
                _encode_uavcan_protocol_param_Value(buffer, msg, chunk_cb, ctx, !fdcan);
            }

            public static uint32_t decode_uavcan_protocol_param_Value(CanardRxTransfer transfer, uavcan_protocol_param_Value msg, bool fdcan) {
                uint32_t bit_ofs = 0;
                _decode_uavcan_protocol_param_Value(transfer, ref bit_ofs, msg, !fdcan);
                return (bit_ofs+7)/8;
            }

            internal static void _encode_uavcan_protocol_param_Value(uint8_t[] buffer, uavcan_protocol_param_Value msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool tao) {
                ...
                switch(msg.uavcan_protocol_param_Value_type) {
                    case uavcan_protocol_param_Value.uavcan_protocol_param_Value_type_t.UAVCAN_PROTOCOL_PARAM_VALUE_TYPE_EMPTY: {
            ...
            internal static void _decode_uavcan_protocol_param_Value(CanardRxTransfer transfer,ref uint32_t bit_ofs, uavcan_protocol_param_Value msg, bool tao) {
                ...
                msg.uavcan_protocol_param_Value_type = (uavcan_protocol_param_Value.uavcan_protocol_param_Value_type_t)uavcan_protocol_param_Value_type;
                bit_ofs += 3;
