...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_equipment_power_PrimaryPowerSupplyStatus(uavcan_equipment_power_PrimaryPowerSupplyStatus msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
