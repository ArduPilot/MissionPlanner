...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_protocol_dynamic_node_id_server_Discovery(uavcan_protocol_dynamic_node_id_server_Discovery msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
