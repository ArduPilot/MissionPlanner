...
namespace DroneCAN
{
    public partial class DroneCAN {
        ...
        {
            public static void encode_ardupilot_equipment_power_BatteryInfoAux(ardupilot_equipment_power_BatteryInfoAux msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool fdcan) {
                uint8_t[] buffer = new uint8_t[8];
                _encode_ardupilot_equipment_power_BatteryInfoAux(buffer, msg, chunk_cb, ctx, !fdcan);
            }

            public static uint32_t decode_ardupilot_equipment_power_BatteryInfoAux(CanardRxTransfer transfer, ardupilot_equipment_power_BatteryInfoAux msg, bool fdcan) {
                uint32_t bit_ofs = 0;
                _decode_ardupilot_equipment_power_BatteryInfoAux(transfer, ref bit_ofs, msg, !fdcan);
                return (bit_ofs+7)/8;
            }

            internal static void _encode_ardupilot_equipment_power_BatteryInfoAux(uint8_t[] buffer, ardupilot_equipment_power_BatteryInfoAux msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool tao) {
            ...
            internal static void _decode_ardupilot_equipment_power_BatteryInfoAux(CanardRxTransfer transfer,ref uint32_t bit_ofs, ardupilot_equipment_power_BatteryInfoAux msg, bool tao) {
