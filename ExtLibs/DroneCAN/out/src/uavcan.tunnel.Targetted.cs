...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_tunnel_Targetted(uavcan_tunnel_Targetted msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool fdcan) {
            uint8_t[] buffer = new uint8_t[8];
            _encode_uavcan_tunnel_Targetted(buffer, msg, chunk_cb, ctx, !fdcan);
        }

        static uint32_t decode_uavcan_tunnel_Targetted(CanardRxTransfer transfer, uavcan_tunnel_Targetted msg, bool fdcan) {
            uint32_t bit_ofs = 0;
            _decode_uavcan_tunnel_Targetted(transfer, ref bit_ofs, msg, !fdcan);
            return (bit_ofs+7)/8;
        }

        static void _encode_uavcan_tunnel_Targetted(uint8_t[] buffer, uavcan_tunnel_Targetted msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool tao) {
        ...
        static void _decode_uavcan_tunnel_Targetted(CanardRxTransfer transfer,ref uint32_t bit_ofs, uavcan_tunnel_Targetted msg, bool tao) {
