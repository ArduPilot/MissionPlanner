...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_equipment_ice_reciprocating_Status(uavcan_equipment_ice_reciprocating_Status msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
