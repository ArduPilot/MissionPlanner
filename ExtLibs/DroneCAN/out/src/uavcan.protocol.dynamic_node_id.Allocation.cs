...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_protocol_dynamic_node_id_Allocation(uavcan_protocol_dynamic_node_id_Allocation msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
