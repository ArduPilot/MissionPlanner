...
namespace DroneCAN
{
    public partial class DroneCAN {
        ...
        {
            public static void encode_uavcan_equipment_gnss_Auxiliary(uavcan_equipment_gnss_Auxiliary msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool fdcan) {
                uint8_t[] buffer = new uint8_t[8];
                _encode_uavcan_equipment_gnss_Auxiliary(buffer, msg, chunk_cb, ctx, !fdcan);
            }

            public static uint32_t decode_uavcan_equipment_gnss_Auxiliary(CanardRxTransfer transfer, uavcan_equipment_gnss_Auxiliary msg, bool fdcan) {
                uint32_t bit_ofs = 0;
                _decode_uavcan_equipment_gnss_Auxiliary(transfer, ref bit_ofs, msg, !fdcan);
                return (bit_ofs+7)/8;
            }

            internal static void _encode_uavcan_equipment_gnss_Auxiliary(uint8_t[] buffer, uavcan_equipment_gnss_Auxiliary msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool tao) {
                memset(buffer,0,8);
                {
            ...
            internal static void _decode_uavcan_equipment_gnss_Auxiliary(CanardRxTransfer transfer,ref uint32_t bit_ofs, uavcan_equipment_gnss_Auxiliary msg, bool tao) {
