...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_protocol_enumeration_Begin_res(uavcan_protocol_enumeration_Begin_res msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
