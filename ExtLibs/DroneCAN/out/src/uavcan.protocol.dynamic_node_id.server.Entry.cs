...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_protocol_dynamic_node_id_server_Entry(uavcan_protocol_dynamic_node_id_server_Entry msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
