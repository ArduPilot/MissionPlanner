...
namespace DroneCAN
{
    public partial class DroneCAN {
        ...
        {
            public static void encode_mppt_Stream(mppt_Stream msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool fdcan) {
                uint8_t[] buffer = new uint8_t[8];
                _encode_mppt_Stream(buffer, msg, chunk_cb, ctx, !fdcan);
            }

            public static uint32_t decode_mppt_Stream(CanardRxTransfer transfer, mppt_Stream msg, bool fdcan) {
                uint32_t bit_ofs = 0;
                _decode_mppt_Stream(transfer, ref bit_ofs, msg, !fdcan);
                return (bit_ofs+7)/8;
            }

            internal static void _encode_mppt_Stream(uint8_t[] buffer, mppt_Stream msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool tao) {
                memset(buffer,0,8);
            ...
            internal static void _decode_mppt_Stream(CanardRxTransfer transfer,ref uint32_t bit_ofs, mppt_Stream msg, bool tao) {
