...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_protocol_enumeration_Begin_req(uavcan_protocol_enumeration_Begin_req msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
