...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_equipment_range_sensor_Measurement(uavcan_equipment_range_sensor_Measurement msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
