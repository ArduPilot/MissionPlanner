...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_olliw_storm32_Control(uavcan_olliw_storm32_Control msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
        ...
        static void _encode_uavcan_olliw_storm32_Control(uint8_t[] buffer, uavcan_olliw_storm32_Control msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool tao) {
            memset(buffer,0,8);
