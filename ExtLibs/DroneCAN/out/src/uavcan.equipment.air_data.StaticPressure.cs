...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_equipment_air_data_StaticPressure(uavcan_equipment_air_data_StaticPressure msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
