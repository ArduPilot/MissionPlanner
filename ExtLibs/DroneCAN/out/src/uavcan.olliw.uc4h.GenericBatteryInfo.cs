...
namespace DroneCAN
{
    public partial class DroneCAN {
        ...
        static void _encode_uavcan_olliw_uc4h_GenericBatteryInfo(uint8_t[] buffer, uavcan_olliw_uc4h_GenericBatteryInfo msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool tao) {
            memset(buffer,0,8);
