...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_equipment_air_data_TrueAirspeed(uavcan_equipment_air_data_TrueAirspeed msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
