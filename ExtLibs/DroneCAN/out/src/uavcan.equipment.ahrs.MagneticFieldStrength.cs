...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_equipment_ahrs_MagneticFieldStrength(uavcan_equipment_ahrs_MagneticFieldStrength msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
