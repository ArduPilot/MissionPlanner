...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_equipment_ice_reciprocating_CylinderStatus(uavcan_equipment_ice_reciprocating_CylinderStatus msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
