...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_protocol_param_ExecuteOpcode_res(uavcan_protocol_param_ExecuteOpcode_res msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
