...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_equipment_camera_gimbal_GEOPOICommand(uavcan_equipment_camera_gimbal_GEOPOICommand msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
