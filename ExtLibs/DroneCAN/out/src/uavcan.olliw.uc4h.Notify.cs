...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_olliw_uc4h_Notify(uavcan_olliw_uc4h_Notify msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
        ...
        static void _encode_uavcan_olliw_uc4h_Notify(uint8_t[] buffer, uavcan_olliw_uc4h_Notify msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool tao) {
            memset(buffer,0,8);
