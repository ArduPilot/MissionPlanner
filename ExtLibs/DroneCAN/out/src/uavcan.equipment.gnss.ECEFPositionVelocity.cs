...
namespace DroneCAN
{
    public partial class DroneCAN {
        static void encode_uavcan_equipment_gnss_ECEFPositionVelocity(uavcan_equipment_gnss_ECEFPositionVelocity msg, dronecan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
