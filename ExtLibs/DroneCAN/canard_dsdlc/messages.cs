...
public partial class DroneCAN {
    public static (Type type,UInt16 msgid, ulong crcseed, Func<Byte[],int, object> convert)[] MSG_INFO = {	(typeof(dronecan_remoteid_BasicID), 20030, 0x5B1C624A8E4FC533, (b,s) => dronecan_remoteid_BasicID.ByteArrayToDroneCANMsg(b,s)),
	(typeof(dronecan_remoteid_Location), 20031, 0xEAA3A2C5BCB14CAA, (b,s) => dronecan_remoteid_Location.ByteArrayToDroneCANMsg(b,s)),
	(typeof(dronecan_remoteid_SelfID), 20032, 0x59BE81DC4C06A185, (b,s) => dronecan_remoteid_SelfID.ByteArrayToDroneCANMsg(b,s)),
	...
	(typeof(mppt_Stream), 20009, 0xDD7096B255FB6358, (b,s) => mppt_Stream.ByteArrayToDroneCANMsg(b,s)),
