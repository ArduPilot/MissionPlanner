...
public interface IGraphics<Region, CompositingMode1, CompositingQuality1, InterpolationMode1, GraphicsUnit,
    PixelOffsetMode1, SmoothingMode1, TextRenderingHint1, Matrix, GraphicsContainer, Pen, FillMode, Icon, Image,
    ImageAttributes, GraphicsPath, Font, Brush, StringFormat, FlushIntention, MatrixOrder, GraphicsState, CombineMode,
    CoordinateSpace>
{
    Region Clip { get; set; }
    ...
    CompositingMode1 CompositingMode { get; set; }

    CompositingQuality1 CompositingQuality { get; set; }

    float DpiX { get; }

    float DpiY { get; }

    InterpolationMode1 InterpolationMode { get; set; }
    ...
    PixelOffsetMode1 PixelOffsetMode { get; set; }

    Point RenderingOrigin { get; set; }

    SmoothingMode1 SmoothingMode { get; set; }

    int TextContrast { get; set; }

    TextRenderingHint1 TextRenderingHint { get; set; }
    ...
    SizeF MeasureString(string text, Font font, SizeF layoutArea, StringFormat stringFormat, out int charactersFitted,
        out int linesFilled);
    ...
    //void SetClip(IGraphics g);

    //void SetClip(IGraphics g, CombineMode combineMode);
