//------------------------------------------------------------------------------
// <copyright file="ImageVisualizerPackage.cs" company="Company">
...
namespace Aberus.VisualStudio.Debugger.ImageVisualizer
{
    ...
    {
        /// <summary>
        /// ImageVisualizerPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "b4569cf1-b9de-4370-b58c-5b841ccddee8";

        /// <summary>
        /// Initializes a new instance of the <see cref="ImageVisualizerPackage"/> class.
        /// </summary>
