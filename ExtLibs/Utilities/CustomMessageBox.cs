...
namespace System
{
    public static class CustomMessageBox
    {
        public delegate DialogResult ShowDelegate(string text, string caption = "",
            MessageBoxButtons buttons = MessageBoxButtons.OK, MessageBoxIcon icon = MessageBoxIcon.None, string YesText = "Yes", string NoText = "No", string CancelText = "Cancel");
        ...
        public static DialogResult Show(string text, string caption = "", MessageBoxButtons MessageBoxButtons = MessageBoxButtons.OK, MessageBoxIcon MessageBoxIcon = MessageBoxIcon.None, string YesText = "Yes", string NoText = "No", string CancelText = "Cancel")
        {
            Console.WriteLine("CustomMessageBox.Show");

            if (ShowEvent != null)
                return ShowEvent.Invoke(text, caption, MessageBoxButtons, MessageBoxIcon, YesText, NoText, CancelText);
