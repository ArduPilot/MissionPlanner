...
namespace MissionPlanner.Utilities
{
    public class tfr
    {
        ...
        static Regex all =
            new Regex(
                @"([R,B]*(L)([N,S])([0-9\.]+)([E,W])([0-9\.]+)|[R,B]*(A)([\+,\-])([N,S])([0-9\.]+)([E,W])([0-9\.]+)([N,S])([0-9\.]+)([E,W])([0-9\.]+)|[R,B]*(C)([N,S])([0-9\.]+)([E,W])([0-9\.]+)[R]([0-9\.]+))",
            ...
            public List<List<PointLatLng>> GetPaths()
            {
                ...
                foreach (Match item in matches)
                {
                    try
                    {
                        ...
                        {
                            var point =
                                new PointLatLngAlt(double.Parse(item.Groups[4].Value, CultureInfo.InvariantCulture),
                                    double.Parse(item.Groups[6].Value, CultureInfo.InvariantCulture));
                        ...
                        {
                            pointcent =
                                new PointLatLngAlt(double.Parse(item.Groups[10].Value, CultureInfo.InvariantCulture),
                                    double.Parse(item.Groups[12].Value, CultureInfo.InvariantCulture));
                            ...
                            pointstart =
                                new PointLatLngAlt(double.Parse(item.Groups[14].Value, CultureInfo.InvariantCulture),
                                    double.Parse(item.Groups[16].Value, CultureInfo.InvariantCulture));
                        ...
                        {
                            var point =
                                new PointLatLngAlt(double.Parse(item.Groups[19].Value, CultureInfo.InvariantCulture),
                                    double.Parse(item.Groups[21].Value, CultureInfo.InvariantCulture));
