...
namespace MissionPlanner.Maps
{
    ...
    public class GMapMarkerRover : GMapMarker
    {
        static readonly System.Drawing.Size SizeSt =
            new System.Drawing.Size(global::MissionPlanner.Maps.Resources.rover.ToBitmap().Width,
                global::MissionPlanner.Maps.Resources.rover.ToBitmap().Height);
        ...
        public override void OnRender(IGraphics g)
        {
            ...
            g.DrawImageUnscaled(global::MissionPlanner.Maps.Resources.rover.ToBitmap(),
                global::MissionPlanner.Maps.Resources.rover.ToBitmap().Width/-2,
                global::MissionPlanner.Maps.Resources.rover.ToBitmap().Height/-2);
