...
namespace System.Drawing
{
    public class Pens
    {
        public static Pen Transparent { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0x00FFFFFF)}};
        ...
        public static Pen AntiqueWhite { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFFAEBD7)}};
        ...
        public static Pen BlanchedAlmond { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFFFEBCD)}};
        ...
        public static Pen CornflowerBlue { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF6495ED)}};
        ...
        public static Pen DarkGoldenrod { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFB8860B)}};
        ...
        public static Pen DarkMagenta { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF8B008B)}};

        public static Pen DarkOliveGreen { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF556B2F)}};
        ...
        public static Pen DarkSeaGreen { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF8FBC8B)}};

        public static Pen DarkSlateBlue { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF483D8B)}};

        public static Pen DarkSlateGray { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF2F4F4F)}};

        public static Pen DarkTurquoise { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF00CED1)}};
        ...
        public static Pen DeepSkyBlue { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF00BFFF)}};
        ...
        public static Pen FloralWhite { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFFFFAF0)}};

        public static Pen ForestGreen { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF228B22)}};
        ...
        public static Pen GreenYellow { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFADFF2F)}};
        ...
        public static Pen LavenderBlush { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFFFF0F5)}};
        ...
        public static Pen LemonChiffon { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFFFFACD)}};
        ...
        public static Pen LightGoldenrodYellow { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFFAFAD2)}};
        ...
        public static Pen LightSalmon { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFFFA07A)}};

        public static Pen LightSeaGreen { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF20B2AA)}};

        public static Pen LightSkyBlue { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF87CEFA)}};

        public static Pen LightSlateGray { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF778899)}};

        public static Pen LightSteelBlue { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFB0C4DE)}};

        public static Pen LightYellow { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFFFFFE0)}};
        ...
        public static Pen MediumAquamarine { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF66CDAA)}};
        ...
        public static Pen MediumOrchid { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFBA55D3)}};

        public static Pen MediumPurple { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF9370DB)}};

        public static Pen MediumSeaGreen { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF3CB371)}};

        public static Pen MediumSlateBlue { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF7B68EE)}};

        public static Pen MediumSpringGreen { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF00FA9A)}};

        public static Pen MediumTurquoise { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF48D1CC)}};

        public static Pen MediumVioletRed { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFC71585)}};

        public static Pen MidnightBlue { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF191970)}};
        ...
        public static Pen NavajoWhite { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFFFDEAD)}};
        ...
        public static Pen PaleGoldenrod { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFEEE8AA)}};
        ...
        public static Pen PaleTurquoise { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFAFEEEE)}};

        public static Pen PaleVioletRed { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFDB7093)}};
        ...
        public static Pen SaddleBrown { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF8B4513)}};
        ...
        public static Pen SpringGreen { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF00FF7F)}};
        ...
        public static Pen YellowGreen { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF9ACD32)}};

        public static Pen ActiveBorder { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFB4B4B4)}};

        public static Pen ActiveCaption { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF99B4D1)}};

        public static Pen ActiveCaptionText { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF000000)}};

        public static Pen AppWorkspace { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFABABAB)}};
        ...
        public static Pen ButtonHighlight { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFFFFFFF)}};

        public static Pen ButtonShadow { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFA0A0A0)}};
        ...
        public static Pen ControlLight { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFE3E3E3)}};

        public static Pen ControlDark { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFA0A0A0)}};

        public static Pen ControlDarkDark { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF696969)}};
        ...
        public static Pen GradientActiveCaption { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFB9D1EA)}};

        public static Pen GradientInactiveCaption { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFD7E4F2)}};
        ...
        public static Pen InactiveCaption { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFBFCDDB)}};

        public static Pen InactiveBorder { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFFF4F7FC)}};
        ...
        public static Pen MenuHighlight { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF3399FF)}};
        ...
        public static Pen WindowFrame { get; } =
            new Pen() {nativePen = new SKPaint() {Color = new SKColor(0xFF646464)}};
