...
namespace Dowding.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OperatorTick :  IEquatable<OperatorTick>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OperatorTick" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OperatorTick() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OperatorTick" /> class.
        /// </summary>
        ...
        /// <param name="ContactId">UUID of Contact that this OperatorTick is attached to (required).</param>
        public OperatorTick(decimal? Ts = null, string CorrelationId = null, string AgentId = null, decimal? Lat = null, decimal? Lon = null, decimal? Hae = null, decimal? Ce = null, decimal? Le = null, decimal? Vn = null, decimal? Ve = null, decimal? Vd = null, Object OtherInfo = null, string Id = null, string ContactId = null)
        {
            // to ensure "Ts" is required (not null)
            if (Ts == null)
            {
                throw new InvalidDataException("Ts is a required property for OperatorTick and cannot be null");
            }
            else
            {
                this.Ts = Ts;
            ...
            {
                throw new InvalidDataException("CorrelationId is a required property for OperatorTick and cannot be null");
            }
            else
            {
            ...
            if (AgentId == null)
            {
                throw new InvalidDataException("AgentId is a required property for OperatorTick and cannot be null");
            }
            else
            {
            ...
            if (Lat == null)
            {
                throw new InvalidDataException("Lat is a required property for OperatorTick and cannot be null");
            }
            else
            {
                this.Lat = Lat;
            ...
            if (Lon == null)
            {
                throw new InvalidDataException("Lon is a required property for OperatorTick and cannot be null");
            }
            else
            {
                this.Lon = Lon;
            ...
            if (ContactId == null)
            {
                throw new InvalidDataException("ContactId is a required property for OperatorTick and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// UUID of Contact that this OperatorTick is attached to
        /// </summary>
        /// <value>UUID of Contact that this OperatorTick is attached to</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OperatorTick);
        }

        /// <summary>
        /// Returns true if OperatorTick instances are equal
        /// </summary>
        /// <param name="other">Instance of OperatorTick to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OperatorTick other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
