...
namespace Dowding.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AgentTick :  IEquatable<AgentTick>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentTick" /> class.
        /// </summary>
        ...
        public AgentTick(string Id = null, decimal? Ts = null, decimal? Lat = null, decimal? Lon = null, decimal? Hae = null, decimal? Ce = null, decimal? Le = null, decimal? Vn = null, decimal? Ve = null, decimal? Vd = null, Object OtherInfo = null, string AgentId = null)
        {
            // to ensure "Ts" is required (not null)
            if (Ts == null)
            {
                throw new InvalidDataException("Ts is a required property for AgentTick and cannot be null");
            }
            else
            {
                this.Ts = Ts;
            ...
            if (Lat == null)
            {
                throw new InvalidDataException("Lat is a required property for AgentTick and cannot be null");
            }
            else
            {
                this.Lat = Lat;
            ...
            if (Lon == null)
            {
                throw new InvalidDataException("Lon is a required property for AgentTick and cannot be null");
            }
            else
            {
                this.Lon = Lon;
            ...
            if (AgentId == null)
            {
                throw new InvalidDataException("AgentId is a required property for AgentTick and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AgentTick);
        }

        /// <summary>
        /// Returns true if AgentTick instances are equal
        /// </summary>
        /// <param name="other">Instance of AgentTick to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AgentTick other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
