...
namespace Dowding.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VehicleTickDto :  IEquatable<VehicleTickDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VehicleTickDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VehicleTickDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VehicleTickDto" /> class.
        /// </summary>
        ...
        public VehicleTickDto(decimal? Ts = null, string CorrelationId = null, string AgentId = null, decimal? Lat = null, decimal? Lon = null, decimal? Hae = null, decimal? Ce = null, decimal? Le = null, decimal? Vn = null, decimal? Ve = null, decimal? Vd = null, Object OtherInfo = null, string Vendor = null, string Model = null, string Serial = null, string VehicleType = null)
        {
            // to ensure "Ts" is required (not null)
            if (Ts == null)
            {
                throw new InvalidDataException("Ts is a required property for VehicleTickDto and cannot be null");
            }
            else
            {
                this.Ts = Ts;
            ...
            {
                throw new InvalidDataException("CorrelationId is a required property for VehicleTickDto and cannot be null");
            }
            else
            {
            ...
            if (AgentId == null)
            {
                throw new InvalidDataException("AgentId is a required property for VehicleTickDto and cannot be null");
            }
            else
            {
            ...
            if (Lat == null)
            {
                throw new InvalidDataException("Lat is a required property for VehicleTickDto and cannot be null");
            }
            else
            {
                this.Lat = Lat;
            ...
            if (Lon == null)
            {
                throw new InvalidDataException("Lon is a required property for VehicleTickDto and cannot be null");
            }
            else
            {
                this.Lon = Lon;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VehicleTickDto {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VehicleTickDto);
        }

        /// <summary>
        /// Returns true if VehicleTickDto instances are equal
        /// </summary>
        /// <param name="other">Instance of VehicleTickDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VehicleTickDto other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
