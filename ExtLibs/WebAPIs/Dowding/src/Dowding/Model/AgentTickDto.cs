...
namespace Dowding.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AgentTickDto :  IEquatable<AgentTickDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentTickDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AgentTickDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentTickDto" /> class.
        /// </summary>
        ...
        /// <param name="Lat">Number representing the agent&#39;s WGS84 latitude at this tick in degrees (required).</param>
        /// <param name="Lon">Number representing the agent&#39;s WGS84 longitude at this tick in degrees (required).</param>
        /// <param name="Hae">Number representing the agent&#39;s height in meters above the WGS84 ellipsoid.</param>
        ...
        /// <param name="Vn">Number representing the velocity east component in meters per second.</param>
        /// <param name="Ve">Number representing the velocity north component in meters per second.</param>
        ...
        /// <param name="AgentId">UUID of AGENT that this AGENT_TICK is attached to (required).</param>
        public AgentTickDto(string Id = null, decimal? Ts = null, decimal? Lat = null, decimal? Lon = null, decimal? Hae = null, decimal? Ce = null, decimal? Le = null, decimal? Vn = null, decimal? Ve = null, decimal? Vd = null, Object OtherInfo = null, string AgentId = null)
        {
            // to ensure "Ts" is required (not null)
            if (Ts == null)
            {
                throw new InvalidDataException("Ts is a required property for AgentTickDto and cannot be null");
            }
            else
            {
                this.Ts = Ts;
            ...
            if (Lat == null)
            {
                throw new InvalidDataException("Lat is a required property for AgentTickDto and cannot be null");
            }
            else
            {
                this.Lat = Lat;
            ...
            if (Lon == null)
            {
                throw new InvalidDataException("Lon is a required property for AgentTickDto and cannot be null");
            }
            else
            {
                this.Lon = Lon;
            ...
            if (AgentId == null)
            {
                throw new InvalidDataException("AgentId is a required property for AgentTickDto and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Number representing the agent&#39;s WGS84 latitude at this tick in degrees
        /// </summary>
        /// <value>Number representing the agent&#39;s WGS84 latitude at this tick in degrees</value>
        [DataMember(Name="lat", EmitDefaultValue=false)]
        public decimal? Lat { get; set; }
        /// <summary>
        /// Number representing the agent&#39;s WGS84 longitude at this tick in degrees
        /// </summary>
        /// <value>Number representing the agent&#39;s WGS84 longitude at this tick in degrees</value>
        [DataMember(Name="lon", EmitDefaultValue=false)]
        public decimal? Lon { get; set; }
        /// <summary>
        /// Number representing the agent&#39;s height in meters above the WGS84 ellipsoid
        /// </summary>
        /// <value>Number representing the agent&#39;s height in meters above the WGS84 ellipsoid</value>
        ...
        /// <summary>
        /// UUID of AGENT that this AGENT_TICK is attached to
        /// </summary>
        /// <value>UUID of AGENT that this AGENT_TICK is attached to</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AgentTickDto);
        }

        /// <summary>
        /// Returns true if AgentTickDto instances are equal
        /// </summary>
        /// <param name="other">Instance of AgentTickDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AgentTickDto other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
