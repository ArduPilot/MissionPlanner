...
namespace MissionPlanner.ArduPilot.Mavlink
{
    ...
    public class CameraProtocol
    {
        ...
        public static Dictionary<(byte, byte, byte), MAVLink.mavlink_video_stream_information_t> VideoStreams { get; private set; } = new Dictionary<(byte, byte, byte), MAVLink.mavlink_video_stream_information_t>();
