...
namespace MissionPlanner.Utilities
{
    class PathFind
    {
        public static List<PointLatLng> FindPath(PointLatLng start, List<Grid.linelatlng> list)
        {
            ...
            foreach (Grid.linelatlng line in list)
            {
        ...
        static PointLatLng findClosestPoint(PointLatLng start, Grid.linelatlng line)
        {
