...
static uavcan_message_descriptor_s uavcan_equipment_air_data_IndicatedAirspeed_descriptor = {
    UAVCAN_EQUIPMENT_AIR_DATA_INDICATEDAIRSPEED_DT_SIG,
    UAVCAN_EQUIPMENT_AIR_DATA_INDICATEDAIRSPEED_DT_ID,

    CanardTransferTypeBroadcast,

    sizeof(uavcan_equipment_air_data_IndicatedAirspeed),
...
static void encode_uavcan_equipment_air_data_IndicatedAirspeed(uavcan_equipment_air_data_IndicatedAirspeed msg, uavcan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
...
static void _encode_uavcan_equipment_air_data_IndicatedAirspeed(uint8_t[] buffer, uavcan_equipment_air_data_IndicatedAirspeed msg, uavcan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool tao) {
