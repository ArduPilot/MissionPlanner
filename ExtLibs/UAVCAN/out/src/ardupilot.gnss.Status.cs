...
namespace UAVCAN
{
    public partial class uavcan {
        static void encode_ardupilot_gnss_Status(ardupilot_gnss_Status msg, uavcan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
        ...
        static void _encode_ardupilot_gnss_Status(uint8_t[] buffer, ardupilot_gnss_Status msg, uavcan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool tao) {
            memset(buffer,0,8);
