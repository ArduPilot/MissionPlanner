...
static uavcan_message_descriptor_s uavcan_protocol_GetNodeInfo_res_descriptor = {
    UAVCAN_PROTOCOL_GETNODEINFO_RES_DT_SIG,
    UAVCAN_PROTOCOL_GETNODEINFO_RES_DT_ID,

    CanardTransferTypeResponse,

    sizeof(uavcan_protocol_GetNodeInfo_res),
...
static void encode_uavcan_protocol_GetNodeInfo_res(uavcan_protocol_GetNodeInfo_res msg, uavcan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
...
static void _encode_uavcan_protocol_GetNodeInfo_res(uint8_t[] buffer, uavcan_protocol_GetNodeInfo_res msg, uavcan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool tao) {
