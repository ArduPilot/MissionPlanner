...
static uavcan_message_descriptor_s uavcan_equipment_device_Temperature_descriptor = {
    UAVCAN_EQUIPMENT_DEVICE_TEMPERATURE_DT_SIG,
    UAVCAN_EQUIPMENT_DEVICE_TEMPERATURE_DT_ID,

    CanardTransferTypeBroadcast,

    sizeof(uavcan_equipment_device_Temperature),
...
static void encode_uavcan_equipment_device_Temperature(uavcan_equipment_device_Temperature msg, uavcan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
...
static void _encode_uavcan_equipment_device_Temperature(uint8_t[] buffer, uavcan_equipment_device_Temperature msg, uavcan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool tao) {
