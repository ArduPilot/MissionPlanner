...
static uavcan_message_descriptor_s uavcan_protocol_file_BeginFirmwareUpdate_req_descriptor = {
    UAVCAN_PROTOCOL_FILE_BEGINFIRMWAREUPDATE_REQ_DT_SIG,
    UAVCAN_PROTOCOL_FILE_BEGINFIRMWAREUPDATE_REQ_DT_ID,
    CanardTransferTypeRequest,
    sizeof(uavcan_protocol_file_BeginFirmwareUpdate_req),
    UAVCAN_PROTOCOL_FILE_BEGINFIRMWAREUPDATE_REQ_MAX_PACK_SIZE,
    encode_func,
    decode_func,
    &uavcan_protocol_file_BeginFirmwareUpdate_res_descriptor
};
*/

static void encode_uavcan_protocol_file_BeginFirmwareUpdate_req(uavcan_protocol_file_BeginFirmwareUpdate_req msg, uavcan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
...
static void _encode_uavcan_protocol_file_BeginFirmwareUpdate_req(uint8_t[] buffer, uavcan_protocol_file_BeginFirmwareUpdate_req msg, uavcan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool tao) {
