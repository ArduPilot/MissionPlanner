...
static uint32_t decode_uavcan_protocol_file_Delete_res(CanardRxTransfer transfer, uavcan_protocol_file_Delete_res msg) {
    uint32_t bit_ofs = 0;
    _decode_uavcan_protocol_file_Delete_res(transfer, ref bit_ofs, msg, true);
    return (bit_ofs+7)/8;
}

static void _encode_uavcan_protocol_file_Delete_res(uint8_t[] buffer, uavcan_protocol_file_Delete_res msg, uavcan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool tao) {
