...
static uavcan_message_descriptor_s uavcan_protocol_dynamic_node_id_server_RequestVote_res_descriptor = {
    UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_SERVER_REQUESTVOTE_RES_DT_SIG,
    UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_SERVER_REQUESTVOTE_RES_DT_ID,
    CanardTransferTypeResponse,
    sizeof(uavcan_protocol_dynamic_node_id_server_RequestVote_res),
    UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_SERVER_REQUESTVOTE_RES_MAX_PACK_SIZE,
    encode_func,
    decode_func,
    null
};
...
static void encode_uavcan_protocol_dynamic_node_id_server_RequestVote_res(uavcan_protocol_dynamic_node_id_server_RequestVote_res msg, uavcan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
...
static void _encode_uavcan_protocol_dynamic_node_id_server_RequestVote_res(uint8_t[] buffer, uavcan_protocol_dynamic_node_id_server_RequestVote_res msg, uavcan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool tao) {
