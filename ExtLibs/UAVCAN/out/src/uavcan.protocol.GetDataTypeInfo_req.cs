...
static uavcan_message_descriptor_s uavcan_protocol_GetDataTypeInfo_req_descriptor = {
    UAVCAN_PROTOCOL_GETDATATYPEINFO_REQ_DT_SIG,
    UAVCAN_PROTOCOL_GETDATATYPEINFO_REQ_DT_ID,
    CanardTransferTypeRequest,
    sizeof(uavcan_protocol_GetDataTypeInfo_req),
    UAVCAN_PROTOCOL_GETDATATYPEINFO_REQ_MAX_PACK_SIZE,
    encode_func,
    decode_func,
    &uavcan_protocol_GetDataTypeInfo_res_descriptor
};
*/

static void encode_uavcan_protocol_GetDataTypeInfo_req(uavcan_protocol_GetDataTypeInfo_req msg, uavcan_serializer_chunk_cb_ptr_t chunk_cb, object ctx) {
    uint8_t[] buffer = new uint8_t[8];
    _encode_uavcan_protocol_GetDataTypeInfo_req(buffer, msg, chunk_cb, ctx, true);
}

static uint32_t decode_uavcan_protocol_GetDataTypeInfo_req(CanardRxTransfer transfer, uavcan_protocol_GetDataTypeInfo_req msg) {
    uint32_t bit_ofs = 0;
    _decode_uavcan_protocol_GetDataTypeInfo_req(transfer, ref bit_ofs, msg, true);
    return (bit_ofs+7)/8;
}

static void _encode_uavcan_protocol_GetDataTypeInfo_req(uint8_t[] buffer, uavcan_protocol_GetDataTypeInfo_req msg, uavcan_serializer_chunk_cb_ptr_t chunk_cb, object ctx, bool tao) {
